...
if __name__ == "__main__":
    try:
        ...
        try:
            ...
            # Configurar archivos externos
            external_stylesheets = []
            external_scripts = []

            if os.path.exists(css_path):
                external_stylesheets.append('/assets/custom_styles.css')
                print("✅ CSS personalizado cargado")
            else:
                print("⚠️  Archivo CSS personalizado no encontrado")

            if os.path.exists(js_path):
                external_scripts.append('/assets/custom_scripts.js')
            ...
            if external_scripts:
                app.config.external_scripts = external_scripts

        except Exception as e:
            print(f"⚠️  Error al configurar archivos personalizados: {str(e)}")
