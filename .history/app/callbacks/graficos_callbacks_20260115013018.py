...
def registrar_graficos_callbacks(app):
    ...
    def callback_actualizar_barra_progreso(historial, estado_ag):
        ...
        try:
            print(f"DEBUG Barra: estado_ag={estado_ag}, historial_keys={list(historial.keys()) if historial else None}")
            ...
            if estado_ag:
                ...
                print(f"DEBUG Barra: Gen={generacion_text}, Fitness={fitness_text}, Porcentaje={porcentaje}%, Style={progress_style}")
