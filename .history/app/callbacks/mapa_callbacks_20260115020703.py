...
def registrar_mapa_callbacks(app):
    ...
    def callback_actualizar_mapa(
        ...
        try:
            ...
            # Determinar si ajustar zoom (durante ejecución del algoritmo)
            ajustar_zoom = estado_ag and estado_ag.get('ejecutando', False) and estado_ag.get('generacion_actual', 0) > 0
