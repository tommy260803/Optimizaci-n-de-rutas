...
def registrar_graficos_callbacks(app):
    ...
    def callback_actualizar_metricas(historial: Optional[Dict]) -> Tuple[str, str, str, str, str, str]:
        """
        ...
        try:
            ...
            print(f"DEBUG Métricas finales: Dist={distancia}, Tiempo={tiempo}, Gen={generacion}, Mejora={mejora}, Fitness={fitness}, Div={diversidad}")
