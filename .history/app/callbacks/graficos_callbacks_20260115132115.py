...
def registrar_graficos_callbacks(app):
    ...
    def callback_actualizar_metricas(
        ...
        try:
            ...
            # Calcular fitness - prioridad: estado_ag > historial
            if estado_ag and 'mejor_fitness' in estado_ag and estado_ag['mejor_fitness'] != 0:
                fitness = f"{estado_ag['mejor_fitness']:.3f}"
            elif 'mejores_fitness' in historial and historial['mejores_fitness']:
