...
def manejar_modal_edicion(lista_puntos, btn_cancelar, modal_open):
    """
    Maneja la apertura y cierre del modal de edición.
    """
    triggered = ctx.triggered_id
...
def registrar_callbacks_disenador(app):
    ...
    try:
        ...
        print("✓ Callback del mapa diseñador registrado manualmente")

    except Exception as e:
        print(f"✗ Error registrando callback del mapa diseñador: {e}")
        import traceback
        traceback.print_exc()
