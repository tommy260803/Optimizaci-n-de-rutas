...
def registrar_callbacks_disenador(app):
    ...
    try:
        ...
        def agregar_punto_directo(click_data, btn_agregar, dataset_actual):
            ...
            print(f"DEBUG: Callback agregar_punto_directo ejecutado")
            print(f"DEBUG: triggered_id: {triggered}")
            print(f"DEBUG: click_data: {click_data}")
            print(f"DEBUG: btn_agregar: {btn_agregar}")
            print(f"DEBUG: dataset_actual: {dataset_actual}")

            if not triggered:
                print("DEBUG: No triggered, retornando no_update")
                return no_update
            ...
            if triggered == "mapa-disenador" and click_data:
                print("DEBUG: Procesando click en mapa")
                ...
                try:
                    ...
                    print(f"DEBUG: Dataset actualizado: {len(dataset_actual)} puntos")
                    return dataset_actual
                except Exception as e:
                    print(f"DEBUG: Error procesando click en mapa: {e}")
                    return no_update

            elif triggered == "btn-agregar-punto-manual":
                print("DEBUG: Procesando botón manual")
            ...
            print(f"DEBUG: No se procesó ninguna acción, triggered: {triggered}")
            return no_update
