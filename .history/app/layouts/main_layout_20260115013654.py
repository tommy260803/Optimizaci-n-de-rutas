    ...
    return dbc.Container(fluid=True, children=[
        ...
        html.Div([
            dbc.Row([
                dbc.Col([
                    html.H1([
                        html.I(className="fas fa-route me-3", style={"color": "#2563eb"}),
        ...
        dbc.Tabs([
            ...
            dbc.Tab(label=[html.I(className="fas fa-route me-2"), "Optimización"], tab_id="optimizacion", children=[
            ...
            dbc.Tab(label=[html.I(className="fas fa-palette me-2"), "Diseñador de Datasets"], tab_id="disenador", children=[
