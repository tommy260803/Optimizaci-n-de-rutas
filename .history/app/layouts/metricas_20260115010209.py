        ...
        dbc.CardBody([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Small(id="progreso-generacion", "0/100", className="text-primary fw-bold"),
                    html.Br(),
                    html.Small("Mejor Fitness: ", className="text-muted"),
                    html.Small(id="progreso-fitness", "0.000", className="text-success fw-bold"),
                    html.Br(),
                    html.Small("Última mejora: ", className="text-muted"),
                    html.Small(id="progreso-ultima", "Generación 0", className="text-info fw-bold"),
                ], className="mt-2")
            ], className="mt-4")
        ])
