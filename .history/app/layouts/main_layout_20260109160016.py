...
def crear_layout() -> dbc.Container:
    ...
    return dbc.Container(fluid=True, children=[
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    html.P(
                        ...
                        "Minimiza tiempo y costo de entrega con visualización en tiempo real.",
        ...
        dbc.Row([
            dbc.Col([
                html.Div([
                    ...
                    html.Small("Listo para iniciar", id="status-text", className="fw-bold")
                ...
                dcc.Loading(
                    ...
                    children=[
                        dcc.Graph(
                            ...
                            className="shadow-sm rounded map-container"
                        )
                    ]
                )
            ], width=12, lg=9, className="mb-4 map-container")
        ], className="mb-4"),
        ...
        dbc.Row(className="mt-4", children=[
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardHeader("📈 Evolución del Algoritmo", className="custom-card-header"),
                    dbc.CardBody(
                        dcc.Loading(
                            id="loading-chart",
                            type="default",
                            children=[
                                dcc.Graph(
                                    ...
                                    config={'displayModeBar': True},
                                    className="shadow-sm rounded chart-container"
                                )
                            ]
                        )
                    )
                ], className="h-100 custom-card chart-container")
            ], width=12, lg=8, className="mb-4"),

            # Panel de métricas
            dbc.Col([
                crear_panel_metricas()
            ], width=12, lg=4, className="mb-4 metrics-panel")
        ]),
