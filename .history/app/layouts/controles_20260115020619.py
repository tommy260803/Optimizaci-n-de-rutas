    ...
    return dbc.Card([
        ...
        dbc.CardBody([
            ...
            html.Div([
                ...
                html.Div([
                    dbc.Checkbox(
                        id='checkbox-zoom-auto',
                        label=[html.I(className="fas fa-search-plus me-2"), "Zoom automático durante ejecución"],
            ...
            html.Div([
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        html.Label([
                            html.I(className="fas fa-clock me-2 text-muted", title="Iteraciones del algoritmo para encontrar la mejor solución"),
                            "Número Generaciones"
                        ], className="slider-label"),
                        dcc.Slider(
                ...
                dbc.Row([
                    dbc.Col([
                        html.Label([
                            html.I(className="fas fa-random me-2 text-muted", title="Probabilidad de combinar dos soluciones para crear descendencia"),
                            "Probabilidad Cruza"
                        ], className="slider-label"),
                        dcc.Slider(
                            id='slider-cruza',
                    ...
                    dbc.Col([
                        html.Label([
                            html.I(className="fas fa-dna me-2 text-muted", title="Probabilidad de modificar aleatoriamente una solución"),
            ...
            html.Div([
                html.H6([
                    html.I(className="fas fa-play-circle me-2 info-icon", title="Controles para ejecutar y gestionar el algoritmo"),
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Button([
                            html.I(className="fas fa-play me-2", title="Inicia la ejecución del algoritmo genético"),
                            "Iniciar Optimización"
                        ], id='btn-iniciar', className="btn-custom btn-success-custom btn-glow w-100 mb-2"),

                        dbc.Button([
                            html.I(className="fas fa-pause me-2", title="Detiene temporalmente la ejecución del algoritmo"),
                            "Pausar"
                    ...
                    dbc.Col([
                        dbc.Button([
                            html.I(className="fas fa-redo me-2", title="Reinicia todos los parámetros y datos del algoritmo"),
                            "Reiniciar"
                        ], id='btn-reiniciar', className="btn-custom btn-danger-custom btn-bounce w-100 mb-2"),

                        dbc.Button([
                            html.I(className="fas fa-download me-2", title="Descarga los resultados en formato JSON"),
                            "Exportar Resultados"
