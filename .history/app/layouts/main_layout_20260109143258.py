...
def crear_layout() -> dbc.Container:
    ...
    return dbc.Container(fluid=True, children=[
        ...
        dbc.Row([
            dbc.Col([
                html.H1(
                    "Optimización de Rutas de Reparto con Algoritmos Genéticos",
                    className="text-center mb-3"
                ),
                html.P(
                    "Herramienta para optimizar rutas de reparto utilizando algoritmos genéticos. "
        ...
        dbc.Row(className="mt-4", children=[
            ...
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody(crear_grafico_convergencia_vacio())
