...
def crear_panel_controles() -> dbc.Card:
    ...
    return dbc.Card([
        ...
        dbc.CardBody([
            ...
            html.Div([
                html.H6([
                    html.I(className="fas fa-database me-2 info-icon"),
            ...
            html.Div([
                html.H6([
                    html.I(className="fas fa-cogs me-2 info-icon"),
                    "Parámetros del Algoritmo Genético"
                ], className="text-primary mb-3 fw-bold"),
                ...
                dbc.Row([
                    dbc.Col([
                        html.Label([
                            html.I(className="fas fa-users me-2 text-muted"),
                            "Tamaño Población"
                        ], className="slider-label"),
                        dcc.Slider(
                            id='slider-poblacion',
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Button(
                            ...
                            id='btn-iniciar',
                            className="btn-custom btn-success-custom btn-glow w-100 mb-2"
                        ),

                        dbc.Button(
                            "⏸️ Pausar",
                            id='btn-pausar',
                            className="btn-custom btn-warning-custom btn-pulse w-100 mb-2",
                            disabled=True
                        )
                    ], width=6),
                    ...
                    dbc.Col([
                        dbc.Button(
                            "🔄 Reiniciar",
                            id='btn-reiniciar',
                            className="btn-custom btn-danger-custom btn-bounce w-100 mb-2"
                        ),

                        dbc.Button(
                            "📊 Exportar Resultados",
                            id='btn-exportar',
                            className="btn-custom btn-secondary-custom btn-ripple w-100"
                        )
                    ], width=6)
                ])
            ])
