        ...
        dbc.CardBody([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    html.Div([
                        html.Div([
                            html.I(className="fas fa-route me-2 text-info", title="Distancia total recorrida en la ruta óptima"),
                            html.H4(
                                "--",
                ...
                dbc.Col([
                    html.Div([
                        html.Div([
                            html.I(className="fas fa-clock me-2 text-warning", title="Tiempo total estimado para completar la ruta óptima"),
                            html.H4(
                                "--",
                                id="metrica-tiempo",
                                className="mb-1"
                ...
                dbc.Col([
                    html.Div([
                        html.Div([
                            html.I(className="fas fa-dna me-2 text-success", title="Generación actual del algoritmo genético"),
                            html.H4(
                                "0/0",
            ...
            dbc.Row([
                ...
                dbc.Col([
                    html.Div([
                        html.Div([
                            html.I(className="fas fa-chart-line me-2", title="Porcentaje de mejora respecto a la solución inicial"),
                            html.H5(
                                "--",
                                id="metrica-mejora",
                                className="mb-1 d-inline"
                ...
                dbc.Col([
                    html.Div([
                        html.Div([
                            html.I(className="fas fa-trophy me-2", title="Mejor valor de aptitud encontrado por el algoritmo"),
                            html.H5(
                                "--",
                                id="metrica-fitness",
                                className="mb-1 d-inline"
                ...
                dbc.Col([
                    html.Div([
                        html.Div([
                            html.I(className="fas fa-users me-2", title="Variabilidad genética de la población actual"),
                            html.H5(
                                "--",
            ...
            html.Div([
            html.H6([
                html.I(className="fas fa-tasks me-2 text-primary", title="Indicador visual del progreso de optimización"),
                "Progreso del Algoritmo"
                ...
                html.Div([
                    html.Small([
                        html.I(className="fas fa-hashtag me-1 text-muted", style={"fontSize": "0.7em"}, title="Iteración actual del algoritmo"),
                        "Generación: "
                    ], className="text-muted"),
                    html.Small("0/100", id="progreso-generacion", className="text-primary fw-bold"),
                    html.Br(),
                    html.Small([
                        html.I(className="fas fa-star me-1 text-muted", style={"fontSize": "0.7em"}, title="Mejor aptitud encontrada hasta ahora"),
                        "Mejor Fitness: "
                    ], className="text-muted"),
                    html.Small("0.000", id="progreso-fitness", className="text-success fw-bold"),
                    html.Br(),
                    html.Small([
                        html.I(className="fas fa-arrow-up me-1 text-muted", style={"fontSize": "0.7em"}, title="Última generación donde se encontró una mejora"),
                        "Última mejora: "
                    ], className="text-muted"),
