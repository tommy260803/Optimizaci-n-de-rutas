    ...
    return dbc.Card([
        ...
        dbc.CardBody([
            ...
            html.H6([
                ...
                html.Div([
                    html.Small([
                        html.I(className="fas fa-hashtag me-1 text-muted", style={"fontSize": "0.7em"}),
                        "Generación: "
                    ], className="text-muted"),
                    html.Small("0/100", id="progreso-generacion", className="text-primary fw-bold"),
                    html.Br(),
                    html.Small([
                        html.I(className="fas fa-star me-1 text-muted", style={"fontSize": "0.7em"}),
                        "Mejor Fitness: "
                    ], className="text-muted"),
                    html.Small("0.000", id="progreso-fitness", className="text-success fw-bold"),
                    html.Br(),
                    html.Small([
                        html.I(className="fas fa-arrow-up me-1 text-muted", style={"fontSize": "0.7em"}),
                        "Última mejora: "
                    ], className="text-muted"),
